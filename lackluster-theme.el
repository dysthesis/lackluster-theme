...
(eval-and-compile
  (defvar lackluster-theme-faces
    ...
    `(completions-annotations ((,c :foreground ,fg-alt)))
    ...
    `(font-lock-function-call-face ((,c :foreground ,fncall)))
    ...
    `(company-tooltip ((,c :background ,bg-popup :foreground ,fg-main)))
    ...
    `(corfu-default ((,c :background ,bg-popup :foreground ,fg-main)))
    ...
    `(vertico-posframe ((,c :background ,bg-popup :foreground ,fg-main)))
    `(vertico-posframe-border ((,c :background ,bg-active)))
    `(vertico-posframe-border-2 ((,c :background ,bg-active)))
    `(vertico-posframe-border-3 ((,c :background ,bg-active)))
    `(vertico-posframe-border-4 ((,c :background ,bg-active)))
    `(vertico-posframe-border-fallback ((,c :background ,bg-active)))
    ...
    `(marginalia-documentation ((,c :foreground ,fg-alt)))
