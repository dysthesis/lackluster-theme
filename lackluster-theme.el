...
the returned value."
  (let ((base-value (symbol-value (lackluster-theme--palette-symbol theme))))
    (if overrides
...
(defvar lackluster-theme-faces
  '(
    ...
    `(magit-branch-remote ((,c :foreground ,lack)))
    `(magit-branch-upstream ((,c :foreground ,fg-dim)))
    `(magit-cherry-equivalent ((,c :foreground ,lack)))
    ...
    `(magit-diff-file-heading ((,c :foreground ,blue)))
    `(magit-diff-file-heading-highlight ((,c :background ,bg-alt :foreground ,blue)))
    ...
    `(magit-popup-heading ((,c :foreground ,blue)))
    ...
    `(magit-reflog-amend ((,c :foreground ,lack)))
    ...
    `(magit-reflog-other ((,c :foreground ,lack)))
    `(magit-reflog-rebase ((,c :foreground ,lack)))
    ...
    `(org-document-title ((,c ,@(lackluster-theme--heading 0) :foreground ,blue)))
    ...
    `(org-level-1 ((,c ,@(lackluster-theme--heading 1) :foreground ,blue)))
    `(org-level-2 ((,c ,@(lackluster-theme--heading 2) :foreground ,blue)))
    `(org-level-3 ((,c ,@(lackluster-theme--heading 3) :foreground ,blue)))
    `(org-level-4 ((,c ,@(lackluster-theme--heading 4) :foreground ,blue)))
    `(org-level-5 ((,c ,@(lackluster-theme--heading 5) :foreground ,blue)))
    `(org-level-6 ((,c ,@(lackluster-theme--heading 6) :foreground ,blue)))
    `(org-level-7 ((,c ,@(lackluster-theme--heading 7) :foreground ,blue)))
    `(org-level-8 ((,c ,@(lackluster-theme--heading 8) :foreground ,blue)))
