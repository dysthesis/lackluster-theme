			...
			(let ((checkdoc-autofix-flag t) \
				...
				(lambda (msg start end &optional unfixable) \
				  (message \"%s:%d:%d: %s\" \
					   ...
					   (current-column) msg)))) \
			(checkdoc-file \"lackluster-theme.el\") \
			(checkdoc-file \"lackluster-dark-theme.el\") \
			(checkdoc-file \"lackluster-hack-theme.el\") \
			(checkdoc-file \"lackluster-mint-theme.el\") \
			(checkdoc-file \"lackluster-night-theme.el\") \
